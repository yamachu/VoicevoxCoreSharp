...
namespace VoicevoxCoreSharp.Core.Compat.v0_15.Native
{
    internal static unsafe partial class CoreUnsafe
    {
        ...
        public delegate VoicevoxResultCode voicevox_open_jtalk_rc_new(byte* open_jtalk_dic_dir, OpenJtalkRc** out_open_jtalk);
        ...
        public delegate VoicevoxResultCode voicevox_open_jtalk_rc_use_user_dict(OpenJtalkRc* open_jtalk, VoicevoxUserDict* user_dict);
        ...
        public delegate void voicevox_open_jtalk_rc_delete(OpenJtalkRc* open_jtalk);

        /// <summary>デフォルトの初期化オプションを生成する @return デフォルト値が設定された初期化オプション</summary>
        public delegate VoicevoxInitializeOptions voicevox_make_default_initialize_options();

        /// <summary>voicevoxのバージョンを取得する。 @return SemVerでフォーマットされたバージョン。</summary>
        public delegate byte* voicevox_get_version();
        ...
        public delegate VoicevoxResultCode voicevox_voice_model_new_from_path(byte* path, VoicevoxVoiceModel** out_model);
        ...
        public delegate byte* voicevox_voice_model_id(VoicevoxVoiceModel* model);
        ...
        public delegate byte* voicevox_voice_model_get_metas_json(VoicevoxVoiceModel* model);
        ...
        public delegate void voicevox_voice_model_delete(VoicevoxVoiceModel* model);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_new(OpenJtalkRc* open_jtalk, VoicevoxInitializeOptions options, VoicevoxSynthesizer** out_synthesizer);
        ...
        public delegate void voicevox_synthesizer_delete(VoicevoxSynthesizer* synthesizer);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_load_voice_model(VoicevoxSynthesizer* synthesizer, VoicevoxVoiceModel* model);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_unload_voice_model(VoicevoxSynthesizer* synthesizer, byte* model_id);
        ...
        public delegate bool voicevox_synthesizer_is_gpu_mode(VoicevoxSynthesizer* synthesizer);
        ...
        [return: MarshalAs(UnmanagedType.U1)]
        public delegate bool voicevox_synthesizer_is_loaded_voice_model(VoicevoxSynthesizer* synthesizer, byte* model_id);
        ...
        public delegate byte* voicevox_synthesizer_create_metas_json(VoicevoxSynthesizer* synthesizer);
        ...
        public delegate VoicevoxResultCode voicevox_create_supported_devices_json(byte** output_supported_devices_json);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_create_audio_query_from_kana(VoicevoxSynthesizer* synthesizer, byte* kana, uint style_id, byte** output_audio_query_json);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_create_audio_query(VoicevoxSynthesizer* synthesizer, byte* text, uint style_id, byte** output_audio_query_json);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_create_accent_phrases_from_kana(VoicevoxSynthesizer* synthesizer, byte* kana, uint style_id, byte** output_accent_phrases_json);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_create_accent_phrases(VoicevoxSynthesizer* synthesizer, byte* text, uint style_id, byte** output_accent_phrases_json);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_replace_mora_data(VoicevoxSynthesizer* synthesizer, byte* accent_phrases_json, uint style_id, byte** output_accent_phrases_json);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_replace_phoneme_length(VoicevoxSynthesizer* synthesizer, byte* accent_phrases_json, uint style_id, byte** output_accent_phrases_json);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_replace_mora_pitch(VoicevoxSynthesizer* synthesizer, byte* accent_phrases_json, uint style_id, byte** output_accent_phrases_json);
        ...
        public delegate VoicevoxSynthesisOptions voicevox_make_default_synthesis_options();
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_synthesis(VoicevoxSynthesizer* synthesizer, byte* audio_query_json, uint style_id, VoicevoxSynthesisOptions options, nuint* output_wav_length, byte** output_wav);

        /// <summary>デフォルトのテキスト音声合成オプションを生成する @return テキスト音声合成オプション</summary>
        public delegate VoicevoxTtsOptions voicevox_make_default_tts_options();
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_tts_from_kana(VoicevoxSynthesizer* synthesizer, byte* kana, uint style_id, VoicevoxTtsOptions options, nuint* output_wav_length, byte** output_wav);
        ...
        public delegate VoicevoxResultCode voicevox_synthesizer_tts(VoicevoxSynthesizer* synthesizer, byte* text, uint style_id, VoicevoxTtsOptions options, nuint* output_wav_length, byte** output_wav);
        ...
        public delegate void voicevox_json_free(byte* json);
        ...
        public delegate void voicevox_wav_free(byte* wav);
        ...
        public delegate byte* voicevox_error_result_to_message(VoicevoxResultCode result_code);
        ...
        public delegate VoicevoxUserDictWord voicevox_user_dict_word_make(byte* surface, byte* pronunciation);

        /// <summary>ユーザー辞書をb&gt;構築&lt;/b&gt;(_construct_)する。  @returns ::VoicevoxUserDict</summary>
        public delegate VoicevoxUserDict* voicevox_user_dict_new();
        ...
        public delegate VoicevoxResultCode voicevox_user_dict_load(VoicevoxUserDict* user_dict, byte* dict_path);
        ...
        public delegate VoicevoxResultCode voicevox_user_dict_add_word(VoicevoxUserDict* user_dict, VoicevoxUserDictWord* word, void/* byte[] */* output_word_uuid);
        ...
        public delegate VoicevoxResultCode voicevox_user_dict_update_word(VoicevoxUserDict* user_dict, void/* byte[] */* word_uuid, VoicevoxUserDictWord* word);
        ...
        public delegate VoicevoxResultCode voicevox_user_dict_remove_word(VoicevoxUserDict* user_dict, void/* byte[] */* word_uuid);
        ...
        public delegate VoicevoxResultCode voicevox_user_dict_to_json(VoicevoxUserDict* user_dict, byte** output_json);
        ...
        public delegate VoicevoxResultCode voicevox_user_dict_import(VoicevoxUserDict* user_dict, VoicevoxUserDict* other_dict);
        ...
        public delegate VoicevoxResultCode voicevox_user_dict_save(VoicevoxUserDict* user_dict, byte* path);
        ...
        public delegate void voicevox_user_dict_delete(VoicevoxUserDict* user_dict);
